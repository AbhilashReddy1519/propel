...
export const IncidentDetail: React.FC<IncidentDetailProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* AI Briefing (or template fallback) -- the plain-language ticket header */}
      {incident.briefing && (
        <div
          style={{
            backgroundColor: 'rgba(102, 181, 255, 0.08)',
            padding: 'var(--space-3)',
            borderRadius: 'var(--radius-sm)',
        ...
        >
          ...
          >
            ...
            <span
              title={
                incident.briefingSource === 'ai'
                  ? 'Generated by AI, phrasing only -- all facts came from the localization engine'
                  : 'AI unavailable -- built from a plain template, same underlying facts'
              }
              style={{
                fontSize: '10px',
                fontWeight: 700,
                ...
                backgroundColor: incident.briefingSource === 'ai' ? 'rgba(124,255,178,0.15)' : 'rgba(139,166,200,0.15)',
                color: incident.briefingSource === 'ai' ? '#7CFFB2' : '#8ba6c8',
              }}
            >
              {incident.briefingSource === 'ai' ? '✦ AI' : '⚙ Template'}
            </span>
          </div>
